...
const AppNavbar = () => {
	...
	return (
		<div className="flex items-center justify-center py-6 w-full px-4 gap-3 sticky z-10 top-0 mx-auto">
			<div className="p-3 bg-accent flex rounded-full dark:rounded shadow-xl">
